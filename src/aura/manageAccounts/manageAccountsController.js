({
    handleAccountDelete : function(component, event, helper) {
        ...
        // Propagate the accountDelete event by recreating it
    ...
    handleAccountEdit : function(component, event, helper) {
        ...
        // which returns the edit-ready Account record from
        // Salesforce, based on the given Account ID
        var setAction = component.get("c.getAccount");
        setAction.setParams({
    ...
    handleNewAccountButtonPress : function(component, event, helper) {
        helper.initVar(component);
    },
    handleQuicksave : function(component, event, helper) {
        ...
        // an accountQuicksave event from the current component
